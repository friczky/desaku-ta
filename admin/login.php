<?php $koneksi = new mysqli('localhost','root','','blog_pw') ;?>
<!DOCTYPE html>
<html>
  <head>
    <meta charset="utf-8">
  ...
  ?>
            ...
            <div class="col-lg-6">
              <div class="form d-flex align-items-center">
                <div class="content">
                  <form method="post" class="form-validate mb-4" action="cek.php">
                    <div class="form-group">
                      <input id="login-username" type="text" name="nama" required data-msg="Masukan Username Terlebih Dahulu" class="input-material">
