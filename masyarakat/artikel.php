...
<?php include 'komponen/sidebar.php'; ?>
 ...
 <div class="page-content">
        ...
        <div class="container-fluid">
          ...
          <h1>Artikel</h1>
          <p align="rigth"><a href="<?php echo $base_url;?>masyarakat/artikel-tambah.php"><button class="btn-success">Tambah Artikel   <i class="fa fa-plus"></i></button></a></p>
           ...
           <!-- /.box-header -->
            <div class="box-body">
              <table id="example1"table class="table table-striped table-bordered " style="width:100%">
                ...
                $query ="SELECT * FROM berita where penulis='$penulis'" ;
