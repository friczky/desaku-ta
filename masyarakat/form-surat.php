...
<form action="" method="post" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="exampleInputtext1" aria-describedby="textHelp" placeholder="" name="nama">
   
  </div>
<div class="form-group">
    <label for="exampleInputtext1">TEMPAT /TGL LAHIR</label>
    <input type="text" class="form-control" id="exampleInputtext1" aria-describedby="textHelp" placeholder="" name="tgl">
    
  </div>
  <div class="form-group">
    <label for="exampleInputtext1">JENIS KELAMIN</label>
    <input type="text" class="form-control" id="exampleInputtext1" aria-describedby="textHelp" placeholder="" name="jk">
   
  </div>
<div class="form-group">
    <label for="exampleInputtext1">ALAMAT</label>
    <textarea type="text" class="form-control" id="exampleInputtext1" aria-describedby="textHelp" placeholder="" name="alamat"></textarea>
   
  </div>
  <div class="form-group">
    <label for="exampleInputtext1">RT/RW</label>
    <input type="text" class="form-control" id="exampleInputtext1" aria-describedby="textHelp" placeholder="" name="rtrw">
   
  </div>
  <div class="form-group">
    <label for="exampleInputtext1">KELURAHAN</label>
    <input type="text" class="form-control" id="exampleInputtext1" aria-describedby="textHelp" placeholder="" name="kel"> 
   
  </div>
  <div class="form-group">
    <label for="exampleInputtext1">KECAMATAN</label>
    <input type="text" class="form-control" id="exampleInputtext1" aria-describedby="textHelp" placeholder="" name="kec">
   
  </div>
  <div class="form-group">
    <label for="exampleInputtext1">KOTA</label>
    <input type="text" class="form-control" id="exampleInputtext1" aria-describedby="textHelp" placeholder="" name="kota">
   
  </div>
  <div class="form-group">
    <label for="exampleInputtext1">PROFINSI</label>
    <input type="text" class="form-control" id="exampleInputtext1" aria-describedby="textHelp" placeholder="" name="prof">
